...
public interface AFD_FSDKLibrary extends Library {
    ...
    AFD_FSDKLibrary INSTANCE = (AFD_FSDKLibrary)LoadUtils.loadLibrary(Platform.isWindows()?Constant.WINDOWS_X64_ARCFACE_FSDK_DETECTION_SO_PATH:Constant.LINUX_X64_ARCFACE_FSDK_DETECTION_SO_PATH,AFD_FSDKLibrary.class);
